...
set output "./png/latency_local_no_warm_up.png"
...
plot \
'./data/mem_local_no_warm_up.dat' lw 1 with linespoints title "no warm up", \
'./data/mem_local.dat' lw 1 with linespoints title "warm up"
